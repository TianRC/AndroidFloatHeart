 ...
 *
 * step5:继续优化动画，这个路径也太单一了吧，全是一个路径上，看起来有点傻不拉几的，
 *
 *
 */
...
public class FloatHeartView extends RelativeLayout {
    ...
    public FloatHeartView(Context context, AttributeSet attrs) {
        ...
        /**动画宽度 范围*/
        animMinWidth = mTypedArray.getInteger(R.styleable.FloatHeartViewAttr_animMaxWidth,
                DisplayUtil.dip2px(context, -60));
        /***/
        animMaxWidth = mTypedArray.getInteger(R.styleable.FloatHeartViewAttr_animMinWidth,
                DisplayUtil.dip2px(context, 120));
        /** 动画高度范围*/
        animMaxHeight = mTypedArray.getInteger(R.styleable.FloatHeartViewAttr_animMaxHeight,
                DisplayUtil.dip2px(context, 333));
        /***/
        animMinHeight = mTypedArray.getInteger(R.styleable.FloatHeartViewAttr_animMinHeight,
